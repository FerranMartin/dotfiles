...
# @raycast.title Video Speed Reset
# @raycast.mode silent
...
# Documentation:
# @raycast.description Reset video playback speed to 1x
...
set jsCode to "var v = document.querySelector('video'); if(v){ v.playbackRate = 1; } else { 'No video element found'; }"
